...
function make_kernel {
	      cp ~/android/op7/Makefile.gcc8 ~/android/op7/Makefile
	      echo
...
function make_boot {
		cp -vr ~/android/op7/out/arch/arm64/boot/Image.gz-dtb ~/android/AnyKernel2/zImage
}
